...
- **Date:** 2026-01-24  
- **Context:** AGENTS.md said `./system/scripts/verify.ps1` which was ambiguous when multiple marge folders exist
- **Decision:** Use explicit `marge-simpson/system/scripts/verify.ps1` in AGENTS.md
