...
const htmlPath = path.join(__dirname, 'flowers.html');
...
console.log('Running tests for flowers.html...\n');

let passed = 0;
let failed = 0;

// Test 1: File exists and is not empty
if (test('flowers.html exists and is not empty', () => {
...
// Test 13: Has flower names
if (test('has flower names displayed', () => {
    assert(htmlContent.includes('flower-name'), 'Should have flower name elements');
    assert(htmlContent.toLowerCase().includes('rose') ||
           htmlContent.toLowerCase().includes('tulip') ||
           htmlContent.toLowerCase().includes('sunflower'),
           'Should include common flower names');
})) passed++; else failed++;

// Test 14: Has flower meanings
if (test('has flower meanings displayed', () => {
    assert(htmlContent.includes('flower-meaning'), 'Should have flower meaning elements');
})) passed++; else failed++;
